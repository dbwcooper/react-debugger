...
function validateSuspenseListNestedChild(childSlot: mixed, index: number) {
  if (__DEV__) {
    ...
    function beginWork(
      current: Fiber | null, // 更新之前的 fiber 节点，为 null 表示是 mount 操作。
      workInProgress: Fiber, // 当前更新的 fiber
      renderLanes: Lanes,
    ): Fiber | null {
      console.log('beginWork workInProgress.tag: ', workInProgress.tag);
